...
public class DeathApplicationQueryBuilder {
    ...
    private static final String BASE_DTR_QUERY = " SELECT dtr.id as id, dtr.tenantId as tenantId, dtr.applicationNumber as applicationNumber, dtr.applicantId as applicantId, dtr.deceasedFirstName as deceasedFirstName, dtr.deceasedLastName as deceasedLastName, dtr.placeOfDeath as placeOfDeath, dtr.timeOfDeath as timeOfDeath, dtr.createdBy as createdBy, dtr.lastModifiedBy as lastModifiedBy, dtr.createdTime as createdTime, dtr.lastModifiedTime as lastModifiedTime, ";
